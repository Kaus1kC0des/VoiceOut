  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4 max-md:mt-10h ">
            <img
          ...
          <p className="text-xl md:text-3xl text-indigo-900 max-w-72 md:max-2-md">
            Connect with Global Community on VoiceOut!
          </p>
        </div>
